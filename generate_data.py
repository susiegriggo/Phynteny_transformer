...
def main(
    ...
    phrogs = pd.read_csv(
        "/home/grig0076/GitHubs/Phynteny_transformer_15012025/Phynteny_transformer/phynteny_utils/phrog_annot_v4.tsv",
        sep="\t",
    )
    ...
    phrog_integer = pickle.load(
        open(
            "/home/grig0076/GitHubs/Phynteny_transformer_15012025/Phynteny_transformer/phynteny_utils/integer_category.pkl",
            "rb",
        )
    )
    phrog_integer = dict(
